...
## Truth has a price. Stake yours.

Verisphere is a technology company building economic infrastructure for factual accountability. We believe that attaching real economic cost to factual assertions — and real economic reward to being right — creates better incentives for truth than likes, votes, or editorial consensus.
...
1. **Every claim has a price.** Publishing a claim costs 1 VSP token, which is burned. This eliminates zero-cost spam.
2. **Staking is conviction.** When you stake VSP on a claim, you're putting real value behind your belief that it's true (or false). The more people stake, the stronger the signal.
3. **Evidence links propagate truth.** Claims can be linked as supporting or challenging evidence for other claims, creating a directed graph of interconnected assertions where credibility flows through the network.
4. **The Verity Score reflects consensus.** Each claim's VS is computed from the ratio and magnitude of support vs. challenge stakes, adjusted for evidence links. High VS means strong economic consensus that a claim is credible. Low VS means the opposite.
...
- **Email:** info@verisphere.co
- **Website:** verisphere.co
